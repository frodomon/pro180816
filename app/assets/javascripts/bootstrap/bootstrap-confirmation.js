	...
	Confirmation.prototype = $.extend({}, $.fn.tooltip.Constructor.prototype, {
		...
		, setContent: function () {
				...
				if (href != "#")
					...
					btnOk.addClass(btnOkClass).html(btnOkLabel).removeAttr('href').attr('target', target).on('click', o.onConfirm);
				btnOk.attr('onclick', $e.closest('[data-toggle="confirmation"]').attr('data-onclick'))
				// GPP: Fin
